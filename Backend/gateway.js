...
const productServiceProxy = createProxyMiddleware({
    target: 'https://localhost:3002', // URL of the product service
    changeOrigin: true,
    secure: false,
    onError: (err, req, res) => {
        console.log(err);
...
const loginServiceProxy = createProxyMiddleware({
    target: 'https://localhost:3001/login', // URL of the user service
    changeOrigin: true,
    secure: false,
    onError: (err, req, res) => {
        console.log(err);
...
const userServiceProxy = createProxyMiddleware({
    target: 'https://localhost:3001', // URL of the user service
    changeOrigin: true,
    secure: false,
    onError: (err, req, res) => {
        console.log(err);
